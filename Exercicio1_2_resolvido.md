...
**Verdadeiro.** `0` pertence ao alfabeto.

2. $1 \in \Sigma$

**Verdadeiro.** `1` pertence ao alfabeto.

3. $01 \in \Sigma$

**Falso.** `01` é uma palavra com dois símbolos, não um símbolo individual.

4. $01 \in \Sigma^*$

**Verdadeiro.** `01` é uma palavra formada apenas por símbolos de `Σ`.

5. $2 \in \Sigma$

**Falso.** `2` não pertence ao alfabeto.

6. $101 \in \Sigma^*$

**Verdadeiro.** Todos os símbolos de `101` pertencem ao alfabeto.
...
**Resposta:** representa `n` ocorrências do símbolo `b`.

3. A palavra `bbbbbb` pertence à linguagem?

**Resposta:** Sim, pois `bbbbbb = b^6` e $6 \geq 1$.

4. A palavra vazia ($\varepsilon$) pertence à linguagem?

**Resposta:** Não, pois a linguagem exige $n \geq 1$.
...
**Resposta:** a linguagem não possui nenhuma palavra.
...
**Resposta:** a linguagem possui uma palavra, que é a palavra vazia.

Depois responda:

1. Qual delas possui uma palavra?

**Resposta:** $L={\varepsilon}$.
...
**Resultado:** todos os itens do checklist foram revisados e respondidos no material.
...
A gramática gera zero ou mais `a` seguidos de um único `b`. Não é possível produzir um `a` depois do `b`.
...
**Resposta:** são palavras formadas por zero ou mais `a` seguidos de um único `b`.
...
A linguagem pode ser representada por:
